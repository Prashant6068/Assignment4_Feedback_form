...
<form action="" method="POST" class="form-si p-4 bg-white p2" enctype="multipart/form-data">
    ...
    <form action="" method="POST">
        <div class="row my-5">
            ...
            <div class="col-sm mb-2">
                <button class="btn btn-danger btn-block " data-toggle="modal" data-target="#exampleModal" type="button" name="">Submit</button>
            </div>
        </div>
    </form>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="" method="POST">
                        <button type="sumbit" name="sub" class="btn btn-danger">Submit</button>
                    </form>
                </div>
            </div>
        </div>
