...
<div class="container my-5 pt-5 c1">
    <form action="" method="POST" class="form-si p-4 bg-white p2">
        <h3 class="text-dark mb-4">Step 2:</h3>
        ...
        <div class="row">
            ...
            <div class="col-sm mb-2">
                <button type="submit" class="btn btn-danger btn-block" name="sub">Next</button>
            </div>
        </div>
    </form>
</div>
