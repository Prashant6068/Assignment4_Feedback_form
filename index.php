        ...
        <section class="">
            <section class="vertical-nav bg-dark text-light shadow p-0" id="sidebar">
                <div class="text-center py-5 mt-4" id="sidebar">
                    <img src="./circle.JPEG" width="125px" height="125px" class=" my-3 rounded-circle img-thumbnail shadow-sm" alt="">
                    <p class="text-danger lead font-weight-bold text-uppercase"><?php echo $user; ?></p>
                    <div class="my-4">
                        <table class="mx-auto text-left" cellpadding="10">
                            ...
                            <tr>
                                ...
                                <td><a class="text-white" href="">Profile</a></td>
                            </tr>
                            <tr>
